...
class Ui_Question(object):
    ...
    def setupUi(self, Question, questionNumber, totalQuestions, topic, matrix1, matrix2):
        ...
        buttonWidth = 380
        self.nextButton = QtWidgets.QPushButton(Question)
        self.nextButton.setGeometry(QtCore.QRect(1600 - buttonWidth, 800, buttonWidth - 100, 90))
...
"border-image: url(" + str(imagesPath) + "Next.png) 0 0 0 0 stretch stretch;")
        ...
        buttonWidth = 380
        self.backButton = QtWidgets.QPushButton(Question)
...
"border-image: url(" + str(imagesPath) + "Back.png) 0 0 0 0 stretch stretch;")
        ...
        self.twodp = QtWidgets.QLabel(Question)
        self.twodp.setGeometry(QtCore.QRect(1000, 150, 500, 100))
        self.twodp.setText("")
        self.twodp.setPixmap(QtGui.QPixmap(imagesPath + "twodp.png"))
        self.twodp.setScaledContents(True)
        self.twodp.setObjectName("twodp")
        self.twodp.raise_()
        
        def createMatrix(matrixCenterX, matrixCenterY, matrixSize, matrix, lineEdit=False):
                realBoxWidth = 50
                realGapWidth = 20
                ...
                for i in range(matrixCells):
                        for j in range(matrixCells):
                                ...
                                returnMatrix[str(i) + str(j)].setGeometry(QtCore.QRect(int(topLeftPositionX + i*(boxWidth+gapWidth)), int(topLeftPositionY + j*(boxWidth+gapWidth)), int(boxWidth), int(boxWidth)))
        ...
        if topic == 0 or topic == 1 or topic == 2:
                ...
                operationWidth = 100    
                self.operation.setGeometry(QtCore.QRect(1600//2 - operationWidth//2, 300, \
                ...
                inputMatrix = createMatrix(800, 700, 200, matrix1, lineEdit=True)
                ...
                if topic == 3:
                        ...
                        self.inputBox = QtWidgets.QLineEdit(Question)
                ...
                "border-image: url(" + str(imagesPath) + "metal.png) 0 0 0 0 stretch stretch;")
                        ...
                        self.inputBox.setObjectName("matrixBox" + "11" + "input")
        ...
        self.label_3.setGeometry(QtCore.QRect(350 - equalsWidth//2, 600, 100, 100))
...
if __name__ == "__main__":
    ...
    ui.setupUi(Question, 2, 10, 2, [[1,2],[3,4]], [[7,5],[2,6]])
